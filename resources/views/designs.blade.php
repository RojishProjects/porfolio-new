...
<head>
    ...
    <title>Graphic Design Showcase — {{ $settings['hero_name'] ?? 'Rojish Bhurtel' }} | Visual & UI Designer · Kawasoti</title>
    <meta name="description" content="Explore the graphic design and visual artwork gallery of {{ $settings['hero_name'] ?? 'Rojish Bhurtel' }}, a creative designer and tech developer based in Kawasoti, Nepal.">
    <meta name="keywords" content="Rojish Bhurtel Designs, Graphic Design Kawasoti, UI/UX Design Nepal, Visual Artwork, Graphic Designer Kawasoti, Rojish Design Portfolio, Creative Designer Nepal">
    ...
    $collectionJson = [
        '@context'    => 'https://schema.org',
        '@type'       => 'CollectionPage',
        'name'        => 'Graphic Design Gallery — ' . ($settings['hero_name'] ?? 'Rojish Bhurtel'),
        'description' => 'A complete collection of visual artwork and design projects by ' . ($settings['hero_name'] ?? 'Rojish Bhurtel') . ' from Kawasoti, Nepal.',
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between py-4">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('projects.index') }}" class="hidden sm:inline-flex items-center gap-1 text-gray-400 hover:text-white px-3 py-2 rounded-xl text-sm font-medium transition-all hover:bg-slate-800">
                            View Projects
                        </a>
            ...
            <div class="max-w-7xl mx-auto relative z-10 text-center animate-fade-in">
                <nav class="flex justify-center mb-4 text-xs font-semibold uppercase tracking-wider text-purple-400" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-2">
                        ...
                        <li class="text-slate-300">Graphic Designs</li>
                    </ol>
                </nav>
                <h1 class="text-4xl md:text-6xl font-extrabold text-white mb-6 tracking-tight">Graphic Design Showcase — {{ $settings['hero_name'] ?? 'Rojish Bhurtel' }}</h1>
                <div class="h-1.5 w-24 bg-gradient-to-r from-purple-500 to-pink-500 mx-auto rounded-full mb-8"></div>
                <p class="text-xl text-gray-400 max-w-2xl mx-auto font-medium">A complete collection of visual artwork, branding, UI/UX designs, and creative media from Kawasoti, Nepal.</p>
            </div>
        </section>

        <!-- Designs Grid -->
        <section class="pb-24 px-4 sm:px-6 lg:px-8" aria-label="Design gallery listing">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="text-center py-20 bg-slate-900 rounded-3xl border border-dashed border-slate-800">
                    <p class="text-gray-500 text-lg font-medium">No graphic designs found at this time.</p>
                </div>
                @endif
            </div>
        </section>
    ...
    <footer class="mt-auto border-t border-slate-900 bg-slate-950 py-12" role="contentinfo">
        <div class="max-w-7xl mx-auto px-4 text-center space-y-4">
            <div class="flex justify-center flex-wrap gap-6 text-sm text-slate-400">
                ...
                <a href="{{ route('projects.index') }}" class="hover:text-purple-400 transition-colors">Projects</a>
