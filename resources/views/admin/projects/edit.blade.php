        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                ...
                <div class="flex items-center gap-2 mt-1">
                    ...
                    <span class="text-sm font-bold text-indigo-500">Editing: {{ $project->title }}</span>
                </div>
            </div>
        </div>
    </x-slot>
                ...
                <div class="p-8 md:p-12 space-y-12">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <x-text-input name="title" type="text" class="block w-full border-slate-100 bg-slate-50/50 rounded-2xl text-base font-bold p-5 focus:ring-indigo-500"
                                :value="old('title', $project->title)" placeholder="e.g. E-Learning Platform" required />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="space-y-3">
                            ...
                            <x-text-input name="category" type="text" class="block w-full border-slate-100 bg-slate-50/50 rounded-2xl text-sm font-bold p-4 focus:ring-indigo-500"
                                :value="old('category', $project->category)" placeholder="e.g. Web Development" />
                        </div>
                        <div class="space-y-3">
                        ...
                        <div class="space-y-3">
                            ...
                            <x-text-input name="icon" type="text" class="block w-full border-slate-100 bg-slate-50/50 rounded-2xl text-sm font-bold p-4 focus:ring-indigo-500"
                                :value="old('icon', $project->icon)" placeholder="e.g. code, globe, server" />
                        </div>
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <textarea name="description" rows="6"
                            ...
                            placeholder="Explain the project...">{{ old('description', $project->description) }}</textarea>
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <x-text-input name="tags" type="text" class="block w-full border-slate-100 bg-slate-50/50 rounded-2xl text-sm font-bold p-4 focus:ring-indigo-500"
                            :value="old('tags', $project->tags ? implode(', ', $project->tags) : '')" placeholder="e.g. Laravel, React, Tailwind (comma separated)" />
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center gap-8 mb-8">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-[10px] text-slate-300">Leave fields empty to keep current image</p>
                            </div>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                            <div class="space-y-4">
                                <label class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">Replace with Upload</label>
